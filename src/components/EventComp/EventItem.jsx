...
const EventItem = ({ event, categories, departments, onEdit, onDelete }) => {
	...
	const department = departments.find(
		d => d.id_department === event.id_department
	)

	const isPastEvent = event.status === 'архив'
			...
			<div className='event-info'>
				...
				<div className='event-details'>
					...
					<div>
						...
						{format(new Date(event.end_datetime), 'dd.MM.yyyy HH:mm')}
					</div>
					<div>
					...
					<div>
						...
						{category?.category_name || 'Не указана'}
					</div>
					<div>
